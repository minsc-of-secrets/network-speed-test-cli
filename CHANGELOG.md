...
- `Cargo.toml` metadata: `repository`, `readme`, `keywords`, `categories`,
  and `rust-version` (MSRV 1.88, verified in CI, and checked in a
  dedicated CI job).
- `CHANGELOG.md`.
...
[Unreleased]: https://github.com/minsc-of-secrets/network-speed-test-cli/compare/v0.1.2...HEAD
[0.1.2]: https://github.com/minsc-of-secrets/network-speed-test-cli/compare/v0.1.1...v0.1.2
